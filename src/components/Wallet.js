...
const Wallet = () => {
  ...
  return (
    <section className='bg-gray-100 text-gray-900 min-h-screen'>
      ...
      </div> : <div className=' justify-center p-40'>
        <p className='text-4xl text-center'> Please Verify Your Email </p>
        <br />
        <p className='text-2xl text-center'>  Verification Link Has been Sent To Your Email </p>
      </div>}
