            ...
            <div className='flex justify-center items-center pt-8'>
                <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
                    <div className='mb-8 text-center'>
                        ...
                        <p className='text-sm text-dark'>Create a new account</p>
                    </div>
                    <form
                        onSubmit={submit}
                        noValidate=''
                    ...
                    >
                        <div className='space-y-4'>
                            <div>
                                <label htmlFor='email' className='block mb-2 text-sm text-dark'>
                                    Name
                                </label>
                                <input
                                    type='text'
                    ...
                    <div className='flex items-center pt-4 space-x-1'>
                        ...
                        <p className='px-3 text-sm text-dark'>
                    ...
                    <div className='flex justify-center space-x-4'>
                        ...
                        <button onClick={githumsubmit} aria-label='Log in with GitHub' className='p-3 rounded-sm'>
                            <svg
                                xmlns='http://www.w3.org/2000/svg'
                                viewBox='0 0 32 32'
                                className='w-5 h-5 fill-current'
